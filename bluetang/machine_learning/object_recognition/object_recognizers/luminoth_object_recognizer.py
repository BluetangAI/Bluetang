...
from bluetang.machine_learning.object_recognition.object_recognizer import ObjectRecognizer
...
class LuminothObjectRecognizer(ObjectRecognizer):
    ...
    def __init__(self, name, algorithm="ssd", classes=None, model_path=None, **kwargs):
        ...
        if self.model_path is not None:
            ...
            if algorithm not in self.__class__.algorithms:
                raise bluetangError(f"Algorithm '{algorithm}' not implemented in {self.__class__.__name__}")
    ...
    def on_interrupt(self, *args):
        ...
        print("Leave everything where it is and run the same 'bluetang train object' command")
